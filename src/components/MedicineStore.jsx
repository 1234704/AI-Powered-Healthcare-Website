...
const medicines = [
  {
    ...
    description: "Panadol Extra provides fast and effective relief from headaches, toothaches, backaches, and fever. Contains paracetamol 500mg + caffeine 65mg for enhanced pain relief.",
    sideEffects: "Nausea, allergic reactions (rare). Do not exceed recommended dose.",
  ...
  },
  {
    ...
    description: "Augmentin is a broad-spectrum antibiotic used to treat bacterial infections including respiratory tract infections, skin infections, and urinary tract infections.",
    sideEffects: "Diarrhea, nausea, skin rash. Avoid if allergic to penicillin.",
  ...
  },
  {
    ...
    stock: "In Stock",
    brand: "Reckitt",
    dosage: "10ml three times daily. Shake well before use.",
    description: "Effective relief from dry and productive cough. Contains dextromethorphan and guaifenesin for dual-action cough suppression and mucus thinning.",
    sideEffects: "Drowsiness, dizziness. Avoid driving after use.",
    prescription: "Not Required",
  },
  {
    id: 4,
    ...
    stock: "In Stock",
    brand: "HealthVit",
    dosage: "1 tablet daily with water after meals.",
    description: "High-dose Vitamin C supplement to boost immunity, promote skin health, and provide antioxidant protection. Effervescent formula for better absorption.",
    sideEffects: "Stomach upset if taken on empty stomach. Generally very safe.",
    prescription: "Not Required",
  },
  {
    id: 5,
    ...
    stock: "Limited Stock",
    brand: "Novo Nordisk",
    dosage: "As prescribed by your doctor. Do not self-administer without guidance.",
    description: "Pre-filled insulin pen for convenient and accurate insulin delivery. Suitable for Type 1 and Type 2 diabetes patients. Requires prescription.",
    sideEffects: "Hypoglycemia, injection site reactions. Monitor blood sugar regularly.",
    prescription: "Required",
  },
  {
    id: 6,
    ...
    description: "Aspirin-based effervescent tablet for fast pain relief, fever reduction, and mild anti-inflammatory action. Dissolves quickly for rapid absorption.",
    sideEffects: "Stomach irritation, not recommended for children under 12.",
    prescription: "Not Required",
  },
  {
    id: 7,
    ...
    description: "Oral Rehydration Salts for rapid rehydration during diarrhea, vomiting, or dehydration. WHO formula with essential electrolytes and glucose.",
    sideEffects: "None when used as directed. Safe for all ages.",
    prescription: "Not Required",
  },
  {
    id: 8,
    ...
    stock: "In Stock",
    brand: "GSK",
    dosage: "Children 6-12 years: 10ml every 4-6 hours. Max 4 doses in 24 hours.",
    description: "Paracetamol-based syrup specially formulated for children. Provides gentle fever and pain relief with a pleasant strawberry flavour.",
    sideEffects: "Rare allergic reactions. Do not exceed recommended dose.",
    prescription: "Not Required",
  },
];
      ...
      <div style={styles.container}>
        ...
        <div style={styles.header}>
          ...
          <p style={styles.subtitle}>
            Genuine medicines delivered to your doorstep. Click any medicine for full details.
          </p>
        </div>
            ...
            >
              ...
              <div style={styles.cardBody}>
                ...
                <div style={styles.cardFooter}>
                  ...
                  <button style={styles.detailBtn} onClick={(e) => { e.stopPropagation(); setSelectedMedicine(med); }}>
                    View Details →
                  </button>
                </div>
              </div>
        ...
        {filteredMedicines.length === 0 && (
          <p style={styles.emptyText}>No medicines found. Try a different search or category.</p>
        )}
      </div>
          ...
          <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <div style={styles.modalTop}>
              <div style={styles.modalIconWrap}>
                <span style={styles.modalIcon}>{selectedMedicine.icon}</span>
              </div>
              <div>
                ...
                <div style={styles.modalBadgeRow}>
                  ...
                  <span style={{
                    ...
                    ...(selectedMedicine.prescription === "Required" ? styles.prescriptionRequired : {})
                  }}>
            ...
            <div style={styles.modalSection}>
              ...
              <p style={styles.modalText}>{selectedMedicine.description}</p>
            </div>

            <div style={styles.modalSection}>
              <h4 style={styles.modalSectionTitle}>💡 Dosage Instructions</h4>
              <p style={styles.modalText}>{selectedMedicine.dosage}</p>
            </div>

            <div style={styles.modalSection}>
              <h4 style={styles.modalSectionTitle}>⚠️ Side Effects</h4>
              <p style={styles.modalText}>{selectedMedicine.sideEffects}</p>
            </div>
...
const styles = {
  ...
  subtitle: { color: "#718096", fontSize: "1rem", maxWidth: "500px", margin: "0 auto" },
  searchBar: { display: "flex", alignItems: "center", background: "white", borderRadius: "14px", padding: "14px 20px", boxShadow: "0 2px 10px rgba(0,0,0,0.06)", maxWidth: "600px", margin: "0 auto 30px", gap: "10px" },
  ...
  categoryBtn: { background: "white", border: "1px solid #E2E8F0", borderRadius: "100px", padding: "8px 18px", fontSize: "0.85rem", fontWeight: "600", color: "#4A5568", cursor: "pointer", transition: "all 0.25s" },
  ...
  detailBtn: { background: "transparent", border: "1px solid #0D9488", color: "#0D9488", borderRadius: "8px", padding: "7px 12px", fontSize: "0.8rem", fontWeight: "700", cursor: "pointer", transition: "all 0.2s" },
  emptyText: { textAlign: "center", color: "#A0AEC0", marginTop: "40px", fontSize: "1rem" },
  ...
  addCartBtn: { background: "#0D9488", color: "white", border: "none", borderRadius: "12px", padding: "14px 28px", fontSize: "0.95rem", fontWeight: "700", cursor: "pointer" },
};
